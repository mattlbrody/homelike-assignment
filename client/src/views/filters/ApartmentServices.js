...
import ApartmentServicesFilter from './ApartmentServicesFilter';
...
class ApartmentServices extends React.Component {
  ...
  filterReset = () => {
    this.props.dispatch({ type: 'SERVICES_RESET' });
  }
...
export default connect(mapStateToProps)(ApartmentServices);